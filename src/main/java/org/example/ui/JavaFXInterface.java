...
public class JavaFXInterface extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        maxTicketCapacityField = new TextField();gridPane.add(new Label("Total Tickets:"), 0, 0);
        ...
        gridPane.add(logTable, 0, 7, 2, 1);// Start button event
    ...
    private void startSystem() throws Exception {
        ...
        Configuration config = new Configuration(totalTickets, ticketReleaseRate,
                customerRetrievalRate, maxTicketCapacity);ticketPool = new TicketPool();
        // Start threads
